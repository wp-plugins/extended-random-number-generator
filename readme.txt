...
Contributors: RTD LLC Development, Whiler
Donate link: TBD
...
By default, the original <a href="http://wordpress.org/extend/plugins/random-number-generator/">Random Number Generator</a> plugin short code works within widgets, posts, and pages. We have extended the core capability of the plugin so that it also works within text/html fields, such as thosed used for advertising purposes.

One primary use: It can be used to <a href="short codes within widgets, posts, and pages.">defeat browser caching</a> by inserting a random number. The most common implementation of this is within Google DoubleClick ads where they require an 'ord=' within the script to ensure that ad creative is not cached by the browers.
